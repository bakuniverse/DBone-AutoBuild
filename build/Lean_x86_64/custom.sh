...
# sed -i 's@## src-git luci https://github.com/coolsnowwolf/luci.git;openwrt-23.05 @src-git luci https://github.com/coolsnowwolf/luci.git;openwrt-23.05@g' feeds.conf.default # 启用23.05Luci
...
CONFIG_TARGET_ROOTFS_PARTSIZE=528
...
# CONFIG_PACKAGE_luci-i18n-passwall2-fa is not set
# CONFIG_PACKAGE_luci-i18n-passwall2-ru is not set
